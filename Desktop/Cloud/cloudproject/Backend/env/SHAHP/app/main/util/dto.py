...
class UserDto:
    ...
    userR = api.model('user Response', {
        'userId': fields.String(required=False, description='user email address'),
        'email': fields.String(required=True, description='user email address'),
        'firstName': fields.String(required=True, description='user username'),
        'lastName': fields.String(required=True, description='user username'),
        # 'password': fields.String(required=True, description='user password'),
...
class UserResponseDto:
    api = Namespace('userR', description='user related operations')
    user = api.model('userR', {
        'userId': fields.String(required=False, description='user email address'),
        'email': fields.String(required=True, description='user email address'),
        'firstName': fields.String(required=True, description='user username'),
        'lastName': fields.String(required=True, description='user username'),
...
class UDTO:
    api = Namespace('auth', description='authentication related operations')
    user_auth = api.model('auth_details', {
        'admin': fields.String(required=True, description='if admin'),
        'user_id': fields.String(required=True, description='The public id '),
        'email': fields.String(required=False, description='email'),
        'registered_on': fields.String(required=False, description='date of registration'),
    })
